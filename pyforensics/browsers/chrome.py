...
import shutil
import puremagic
from pyforensics.browsers.webbrowser import WebBrowser
from pyforensics import utils
...
class Chrome(WebBrowser):
    ...
    def decrypt_cookie(self, encrypted_value):
        """Decryption based on work by Nathan Henrie and Jordan Wright as well as Chromium source:
         ...
         - Windows: https://gist.github.com/jordan-wright/5770442
    ...
    def get_site_characteristics(self, path, dir_name):
        ...
        for item in items:
            try:
                from pyforensics.lib.site_data_pb2 import SiteDataProto
    ...
    class URLItem(WebBrowser.URLItem):
        ...
        def decode_transition(self):
            ...
            qualifiers_friendly = {
                ...
                0x20000000: 'Navigation Chain End',   
